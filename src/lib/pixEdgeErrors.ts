...
const MESSAGES: Record<string, string> = {
  ...
  invalid_amount: "Valor inválido. Depósito: R$ 5,00 a R$ 5.000,00. Saque: R$ 30,00 a R$ 5.000,00.",
  withdraw_amount_out_of_bounds: "Saque mínimo de R$ 30,00 e máximo de R$ 5.000,00.",
