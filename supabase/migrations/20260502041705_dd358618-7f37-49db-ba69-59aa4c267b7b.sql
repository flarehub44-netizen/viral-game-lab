...
DECLARE
  ...
  anchors numeric[][] := ARRAY[
    ...
    -- Cauda Fase 2 achatada (era ×26 a ×50)
    ARRAY[33::numeric, 22.0::numeric],
    ARRAY[38::numeric, 25.0::numeric],
    ARRAY[45::numeric, 28.0::numeric],
    ARRAY[60::numeric, 30.0::numeric]
  ];
  hard_cap numeric := 30.0;
  i int;
